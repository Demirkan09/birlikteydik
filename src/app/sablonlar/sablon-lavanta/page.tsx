...
// 👑 ANA SAYFA COMPONENT
// ─────────────────────────────────────────────────────────────────────────────
export default function LavantaTemplate() {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[480px] mx-auto min-h-screen bg-[#0A0314] shadow-[0_0_80px_rgba(0,0,0,0.85)] border-x border-white/5 z-10 flex flex-col">
        {/* Müzik Widget'ı */}
