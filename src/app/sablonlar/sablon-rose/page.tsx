...
// ─────────────────────────────────────────────────────────────────────────────
const config = {
  coupleNames: "Ceren & Arda",
  tagline: "Güllerin pembe yapraklarında yazılı olan en zarif aşk şiirim sensin...",
  accentColor: "#FCA5A5", // Varsayılan: Altın Sarısı (#C9A84C)
...
function MusicVinylWidget({ isPlaying, toggleMusic }: { isPlaying: boolean; toggleMusic: () => void }) {
  return (
    <div
      ...
      style={{
        background: "linear-gradient(135deg, #100305 0%, #1C080B 60%, #100305 100%)",
    ...
    >
      ...
      <div className="relative flex-shrink-0" style={{ width: 44, height: 44 }}>
        ...
        >
          ...
          >
            <div style={{ width: "3px", height: "3px", borderRadius: "50%", background: "#100305" }} />
          </div>
        </motion.div>
      </div>
...
export default function RoseTemplate() {
  ...
  return (
    <main
      ...
      style={{ background: "#100305", color: "#FFFFFF" }}
    >
      {/* PARÇACIK EFEKTİ */}
      <HeartsCanvas />

      {/* Mobil Uyumlu Merkez Çerçeve Wrapper */}
      <div className="relative w-full max-w-[480px] mx-auto min-h-screen bg-[#100305] shadow-[0_0_80px_rgba(0,0,0,0.85)] border-x border-white/5 z-10 flex flex-col">
        {/* Müzik Widget'ı */}
